...
+ (UIImage *)imageFromVideo:(NSURL *)videoURL;
...
+ (UIImage *)imageFromVideo:(NSURL *)videoURL {
    ...
    CMTime thumbnailImageTime = [asset duration];
    thumbnailImageTime.value = 0;
    
    NSError *igError = nil;
    thumbnailImageRef = [assetIG copyCGImageAtTime:thumbnailImageTime
                                        actualTime:NULL
                                             error:&igError];
    if (!thumbnailImageRef) {
        ...
        UIImage *image = [[UIImage alloc] initWithCGImage:thumbnailImageRef];
